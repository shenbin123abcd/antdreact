...
gulp.task('build',['sass','images','webpackWithImage','copy:js:vendor','copy:js:react:bundle'], function () {
    ...
    return gulp.src('src/index.html')
        ...
        .pipe(plugins.open({uri:`http://${appConfig.devDomain}/admin#/cehua`}))
        // .pipe(gulp.dest('dest'))
...
gulp.task("watch:dev", ['copy:view','copy:css','copy:js','images:dev','copy:js:vendor'], function(){
