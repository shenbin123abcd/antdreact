...
export function productPutOnShelfModalShow(data) {
    // console.log(23)
    return {
        type: 'PRODUCT_PUT_ON_SHELF_MODAL_SHOW',
        data,
    }
}
export function productPutOnShelfModalShow2(data) {
    // console.log(23)
    return {
        type: 'PRODUCT_PUT_ON_SHELF_MODAL_SHOW2',
        data,
    }
}

export function productPutOnShelfModalHide(data) {
    // console.log(23)
    return {
        type: 'PRODUCT_PUT_ON_SHELF_MODAL_HIDE',
        data,
    }
}
